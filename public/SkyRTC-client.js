var SkyRTC = function() {
    ...
    /*                                                        */
    /*                   socket setup                         */
    /*reference to http://segmentfault.com/a/1190000000436544 */  
    /*                                                        */
    /**********************************************************/
    ...
    function skyrtc() {
        ...
        //current room
        this.room = "";
        //used  to save receive file
        this.fileData = {};
        // local WebSocket connect
        this.socket = null;
        //local socket id
        this.me = null;
        // save connected peer connection to local， key: socket id，value: Type of PeerConnection
        this.peerConnections = {};
        //save all socket id connected with local 
        this.connections = [];
        //construct connected number 
        this.numStreams = 0;
        //connected number
        this.initializedStreams = 0;
        //save data channel，key:socket id，value is created by createChannel
        this.dataChannels = {};
        //save data channel and file state
        this.fileChannels = {};
        //save all received file
        this.receiveFiles = {};
    }
    ...
    //add local stream into all PeerConnection instance
    ...
    //Combine stream to video for output
    ...
    //Receive Offer signal and reply answer signal 
    ...
    //receive answer signal and write session description into PeerConnection
    ...
    //Create PeerConnections with other user
    ...
    //Create Data channel for a specific PeerConnection
    ...
    //Bind corresponding event callback function for Data channel
    ...
    // Parse the type of file on Data channel to determine signal type
    ...
    //Send file for all user in the room by Data Channel
    ...
    //Send a file for a specific user
    ...
    //If accepted a file, then begin transfer file 
    ...
    //If refuse a file, clear file information in local
    ...
    //Combine a entire file and download
    ...
    //Record file information after received send file request.
